GraphResult<-function(nfile,classifiers,simpleclass,BTree,gene,boxflag=FALSE, type=FALSE)
{
  ...
  if((ntree>1)&&(ngene==1))
  {
    ...
    plot(0,0,xlim = c(0,50),ylim = c(0.5,1.0),type = "n",xlab="Ensemble size",ylab="Accuracy",xaxt="n")
    for (i in 1:nclassif){
  ...
  if((ngene>1)&&(ntree==1))
  {
    ...
    plot(0,0,xlim = c(0,50),ylim = c(0,1.1),type = "n",xlab="Feature size",ylab="Accuracy",xaxt="n")
    for (i in 1:nclassif){
